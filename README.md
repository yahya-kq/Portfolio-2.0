...
- **Dashboards & Business Intelligence**: Interactive Power BI reporting systems tracking multi-channel sales, customer retention cohorts, workforce analytics, and supply chain operations.
...
- **Analytics & BI**: Power BI (DAX, Power Query), Excel (Advanced Modeling)
- **Data & Programming**: SQL, Python (Pandas, NumPy, Matplotlib)
- **Finance & Accounting**: DCF Valuation, Financial Statement Analysis, Ratio & Variance Analysis, SAP FICO (S/4HANA)
